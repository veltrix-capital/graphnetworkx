...
from graphnetworkx.algorithms.community.quality import modularity

from graphnetworkx.utils.mapped_queue import MappedQueue
...
def greedy_modularity_communities(G, weight=None, resolution=1):
    ...
    Examples
    --------
    >>> from graphnetworkx.algorithms.community import greedy_modularity_communities
