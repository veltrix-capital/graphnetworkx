...
from graphnetworkx.utils.decorators import argmap
from graphnetworkx.algorithms.community.community_utils import is_partition
...
def modularity(G, communities, weight="weight", resolution=1):
    ...
    Examples
    --------
    >>> import graphnetworkx.algorithms.community as nx_comm
