...
from graphnetworkx.algorithms.approximation import min_weighted_dominating_set
from graphnetworkx.algorithms.approximation import min_edge_dominating_set
