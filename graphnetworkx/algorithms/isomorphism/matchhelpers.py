...
Examples
--------
>>> import graphnetworkx.algorithms.isomorphism as iso
...
>>> from graphnetworkx.algorithms.isomorphism.matchhelpers import close
>>> from graphnetworkx.algorithms.isomorphism import generic_node_match
