...
from graphnetworkx.exception import NetworkXNoPath
...
from graphnetworkx.algorithms.flow import preflow_push
...
def edge_disjoint_paths(
    ...
    and undirected graphs, and can use all flow algorithms from graphnetworkx flow
    package.
