...
from graphnetworkx import complete_graph
from graphnetworkx import DiGraph
from graphnetworkx import empty_graph
from graphnetworkx import path_graph
from graphnetworkx import wiener_index
