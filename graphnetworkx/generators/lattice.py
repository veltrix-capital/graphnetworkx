...
from graphnetworkx.classes import set_node_attributes
from graphnetworkx.exception import NetworkXError
from graphnetworkx.relabel import relabel_nodes
from graphnetworkx.utils import flatten, nodes_or_number, pairwise
from graphnetworkx.generators.classic import cycle_graph
from graphnetworkx.generators.classic import empty_graph
from graphnetworkx.generators.classic import path_graph
...
def grid_graph(dim, periodic=False):
    ...
    >>> from graphnetworkx import grid_graph
    ...
    6
    """
    from graphnetworkx.algorithms.operators.product import cartesian_product
...
def triangular_lattice_graph(
    ...
    from graphnetworkx.algorithms.minors import contracted_nodes
