...
from graphnetworkx.generators.duplication import duplication_divergence_graph
from graphnetworkx.generators.duplication import partial_duplication_graph
