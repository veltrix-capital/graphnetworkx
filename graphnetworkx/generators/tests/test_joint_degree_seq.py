import time
from graphnetworkx.algorithms.assortativity import degree_mixing_dict
from graphnetworkx.generators import powerlaw_cluster_graph, gnm_random_graph
from graphnetworkx.generators.joint_degree_seq import (
