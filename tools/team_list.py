...
GraphNetworkx development is guided by the following core team:
...
We thank these previously-active core developers for their contributions to GraphNetworkx.
